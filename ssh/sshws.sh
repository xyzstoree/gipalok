...
wget -q -O /usr/bin/proxy3.js "https://github.com/xyzstoree/gipalok/main/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://github.com/xyzstoree/gipalok/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler

...
echo -e ""
case $opt in
1) clear ; menu-domain ; menu-set ;;
2) clear ; port-change ; menu-set ;;
3) clear ; menu-webmin ; menu-set ;;
4) clear ; speedtest ; menu-set ;;
5) clear ; about ; menu-set ;;
6) clear ; auto-reboot ; menu-set ;;
7) clear ; restart ; menu-set ;;
8) clear ; bw ; menu-set ;;
0) clear ; menu ; menu-set ;;
x) menu-set ;;
